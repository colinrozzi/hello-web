...
<body style=\"font-family:system-ui,-apple-system,sans-serif;max-width:40rem;margin:4rem auto;padding:0 1.2rem;line-height:1.6\">\n\
<h1>hello from Theater</h1>\n\
<p>This is <b>hello-web</b> — a minimal two-actor, actor-per-connection HTTP\n\
server running as a Theater actor. An acceptor listens and hands each connection\n\
to a fresh handler; the handler answers one request and shuts down.</p>\n\
<p>Replace this handler&rsquo;s response with your own content to build your site.</p>\n\
</body></html>\n";
